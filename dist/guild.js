(() => {
  ...
  if (isInIframe) {
    ...
    setTimeout(checkAndImport, 1e3);
  } else {
    let createImportButton = function() {
      if (document.getElementById("rr-companion-import-btn"))
        return;
    ...
    if (document.readyState === "loading") {
      document.addEventListener("DOMContentLoaded", () => setTimeout(createImportButton, 1e3));
    } else {
      setTimeout(createImportButton, 1e3);
    }
  }
})();
